...
class EntryForm extends Form
{
    ...
    {
        $fieldset = new Line($this->generateLineName(), [
            'index' => $this->lineCounter
        ]);

        $this->populateBetLine($fieldset, $line);
    ...
    /**
     * Populates element if data exists.
     *
     * @param $element
     * @param $data[Bet|array]
     */
    protected function populateBetLine($element, $data)
    {
        if (!$data) {
            return;
        }

        if ($data instanceof BetLine) {
            $data = $data->toArray();
        }
     ...
     * @return string
     */
    protected function generateLineName() {
        return $name = "lines_" . $this->lineCounter;
    }
} 